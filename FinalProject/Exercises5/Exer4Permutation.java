...
public class Exer4Permutation {
    public static void main(String[] args) {
        ...
        System.out.println(">[Part 4: Permutation]<".indent(18));

        System.out.println("[!] To get the Permutation [!]");
        System.out.println("[-] Enter the (# of Items) separated by a comma\n    then the (# of ways it's ordered) as demonstrated below\n");
        
        boolean isError = false;
        do {
            try {
                System.out.println("-".repeat(24)+ "<[ INPUT ]>" +"-".repeat(24)+"\n");
